...
Portfolio of **deep learning projects** from the **IBM Professional Certificate**, covering **CNNs, RNNs, transfer learning, data pipelines, multimodal vision, and NLP** using **PyTorch** and **TensorFlow/Keras**.  
...
2. **Deep Learning with Keras and TensorFlow**  
   *Final Project: Classify Waste Products Using Transfer Learning and Fine-Tuning*  

3. **Introduction to Neural Networks and PyTorch**  
   *Final Project: League of Legends Match Predictor*  

4. **Deep Learning with PyTorch**  
   *Final Project: Fashion-MNIST Image Classification*  

5. **AI Capstone Project with Deep Learning**  
   *Final Project: CNN + Vision Transformer Integration for Land Classification*  
